...
const LOOK_ROWS := [
	...
	["Wire width px", ["look", "wire_width"], 0.2, 6.0, 0.01],
	["Wire opacity", ["look", "wire_opacity"], 0.0, 1.0, 0.01],
	["Diagonals", ["look", "wire_diagonal"], 0.0, 1.0, 0.01],
	["Min spacing px", ["look", "wire_min_spacing"], 1.0, 40.0, 0.5],
	["Major every", ["look", "wire_major"], 1.0, 64.0, 1.0],
	["Fill gain", ["look", "fill_gain"], 0.0, 2.0, 0.01],
	["Reveal edge", ["look", "reveal_edge"], 0.0, 400.0, 1.0],
	["Wipe glow", ["look", "wipe_glow"], 1.0, 400.0, 1.0],
	["Vignette", ["look", "vignette"], 0.0, 1.0, 0.01],
	["Ambient", ["look", "ambient_energy"], 0.0, 2.0, 0.01],
	["Ambient red", ["look", "ambient_color", 0], 0.0, 1.0, 0.01],
	["Ambient green", ["look", "ambient_color", 1], 0.0, 1.0, 0.01],
	["Ambient blue", ["look", "ambient_color", 2], 0.0, 1.0, 0.01],
...
const EFFECT_ROWS := [
	...
	["Light yaw", ["effects", "light_yaw_offset"], -180.0, 180.0, 1.0],
	["Light yaw/s", ["effects", "light_yaw_rate"], -2.0, 2.0, 0.01],
...
const CAMERA_ROWS := [
	...
	["Distance", ["chapter", "camera", "distance"], 200.0, 14000.0, 10.0],
	...
	["Dolly/s", ["chapter", "camera", "distance_rate"], -600.0, 600.0, 1.0],
...
const CONTENT_ROWS := [
	["View A", ["chapter", "view_a"], 0.0, 7.0, 1.0],
	["View B", ["chapter", "view_b"], 0.0, 7.0, 1.0],
	...
	["Wipe end", ["chapter", "wipe_end"], -20000.0, 20000.0, 10.0],
	["Wipe width", ["chapter", "wipe_width"], 1.0, 2000.0, 1.0],
	...
	["Res start", ["chapter", "resolution_start"], 8.0, 512.0, 8.0],
	...
	["Fill breath", ["chapter", "fill_breath"], 0.0, 2.0, 0.01],
	["Texture at", ["chapter", "texture_time"], 0.0, 145.0, 0.001, TIME],
	["Texture time", ["chapter", "texture_duration"], 0.05, 6.0, 0.05],
	["Parallax at", ["chapter", "parallax_time"], 0.0, 145.0, 0.001, TIME],
